...
import LoginImg from '../assets/imgs/loginImg.webp'

const Login = () => {
  return (
    <div id='Login' className='flex w-full h-screen bg-gray-800'>
        
        <div className="flex items-center justify-center h-screen cellphone:w-full sm:w-full font-kavoon">
            <div className='text-white w-96 '>
                ...
                <div className='mt-3'>
                    ...
                    <div className='flex flex-col items-center mt-3 gap-y-4'>
                        <Link to="/" className=' px-20 active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01] ease-in-out [background-color:#D9D9D9] text-gray-600 text-lg font-bold py-3 rounded-xl'>A ordenar!!</Link>


                        <button className=' px-5 flex items-center justify-center gap-2 active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01] ease-in-out  bg-green-500 text-white-600 text-lg font-bold py-3 rounded-xl'>
        ...
        <div className="w-[100%] h-screen bg-cover  cellphone:hidden sm:flex lg:flex" >
            <img src={LoginImg} className='object-cover w-full h-screen opacity-60 ' alt="" />    
        </div>
