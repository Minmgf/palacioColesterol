        ...
        <div className='text-white w-96'>
            ...
            <div className='mt-3'>
                ...
                <div className='flex flex-col items-center mt-3 gap-y-4'>
                    <Link to="/" className=' px-20 active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01] ease-in-out transition-all [background-color:#D9D9D9] text-gray-600 text-lg font-bold py-3 rounded-xl'>A ordenar!!</Link>
